 ...
 */
public class AfinalRoundedImageView extends ImageView {
  ...
  public AfinalRoundedImageView(Context context) {
    super(context);
  }

  public AfinalRoundedImageView(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public AfinalRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
